...
app.get("/jokes/:id", (req, res) => {
  ...
  const idJoke = jokes.find((joke) => joke.id === id);
  res.json(idJoke);
})
...
app.put("/jokes/:id", (req, res) => {
  ...
  const ixdJoke = jokes.findIndex((joke) => joke.id === id);
  jokes[ixdJoke] = repJoke
